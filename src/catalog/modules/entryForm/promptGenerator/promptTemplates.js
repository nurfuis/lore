const UNIVERSE = "specified lore";
const FACTIONS = "";

export const promptTemplates = {
  location:
    "What are some challenges faced by citizens or beings in the " +
    UNIVERSE +
    " region?",
  appearance: "What would this look like in the " + UNIVERSE + " universe?",
  name:
    "Utilize a naming convention that reflects the cultural influences of the " +
    UNIVERSE +
    " universe.",

  alias: "Provide a nickname or alternative name.",

  description: "Provide a short summary of the entry entry.",
  ...
  flora_and_fauna: "Describe the plant and animal life, if any.",
