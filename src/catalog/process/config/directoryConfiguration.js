...
const SPRITE_LIBRARY = "/loreLibrarySprites.json";
exports.SPRITE_LIBRARY = SPRITE_LIBRARY;
const TEMPLATES_FILE = "/loreLibraryTemplates.json";
exports.TEMPLATES_FILE = TEMPLATES_FILE;
const LORE_LIBRARY = "/loreLibrary.json";
exports.LORE_LIBRARY = LORE_LIBRARY;
const LORE_LIBRARY_TEMP = "/loreLibrary.temp.json";
exports.LORE_LIBRARY_TEMP = LORE_LIBRARY_TEMP;
const LORE_LIBRARY_BAK = "/loreLibrary.bak.json";
